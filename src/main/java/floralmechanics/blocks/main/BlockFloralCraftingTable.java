package floralmechanics.blocks.main;
...
public class BlockFloralCraftingTable extends BlockBase implements ITileEntityProvider {
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	
	public BlockFloralCraftingTable(String name, Material material) {
		super(name, material);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.FLORAL_CRAFTING_TABLE);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(ModBlocks.FLORAL_CRAFTING_TABLE);
	}
